...
public class User extends AbstractNamedEntity {
    ...
    @CollectionTable(name = "user_roles", // имя таблицы для связи users и roles
            ...
            uniqueConstraints = {@UniqueConstraint( // добавляем ограничение
...
//    @ElementCollection(fetch = FetchType.LAZY) // а так не подтянет через left outer join
    ...
    // mappedBy = "user" => meals главное поле в отношениях, у подчинённого есть поле user, которое ссылается на главное
    // !!! а соответствующей колонки в таблице users не будет
    ...
    public User(Integer id,
        ...
        setRoles(roles);
        this.meals = meals == null ? emptyList() : meals;
    }
