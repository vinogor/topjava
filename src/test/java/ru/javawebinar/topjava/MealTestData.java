...
public class MealTestData {
    ...
    public static final Meal MEAL5 = new Meal(USER_MEAL_ID + 4, of(2020, Month.JANUARY, 31, 10, 0), "Завтрак", 500);
    public static final Meal MEAL6 = new Meal(USER_MEAL_ID + 5, of(2020, Month.JANUARY, 31, 13, 0), "Обед", 1000);
    ...
    public static Meal getUpdated() {
        return new Meal(USER_MEAL_ID, MEAL1.getDateTime(), "Обновленный завтрак", 200);
    }
}
